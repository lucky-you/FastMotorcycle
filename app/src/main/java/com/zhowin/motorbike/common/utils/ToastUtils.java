...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = BaseApplication.getInstance().getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        Utils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(BaseApplication.getInstance(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        Utils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(BaseApplication.getInstance());
                iToast.setView(view);
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private void realShow() {
            ...
            mParams.packageName = BaseApplication.getInstance().getPackageName();
